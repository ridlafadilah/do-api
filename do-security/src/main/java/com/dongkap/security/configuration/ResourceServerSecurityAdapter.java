...
public class ResourceServerSecurityAdapter extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers(HttpMethod.PUT,"/api/"		+resourceId+ "/trx/put/**")
        	.access("#oauth2.hasScope('write')")
        .antMatchers(HttpMethod.POST,"/api/"		+resourceId+ "/oauth/**")
        	.access("#oauth2.hasScope('read')")
        .antMatchers(HttpMethod.GET,"/api/"		+resourceId+ "/oauth/**")
        	.access("#oauth2.hasScope('read')")
        .antMatchers(HttpMethod.DELETE,"/api/"		+resourceId+ "/oauth/**")
        	.access("#oauth2.hasScope('read')")
        .antMatchers(HttpMethod.PUT,"/api/"		+resourceId+ "/oauth/**")
        	.access("#oauth2.hasScope('read')")
